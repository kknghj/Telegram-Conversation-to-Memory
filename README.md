...
- Worker 디스크는 **휘발성**입니다. 진행·취소 초안은 SQLite(`data/memory_archive.db`)에 저장되며, 재배포·재시작 시 초안 상태가 사라질 수 있습니다. 승인된 최종 기억은 `STORAGE_BACKEND=supabase`일 때 Supabase에 유지됩니다.
